  ...
  describe 'MealTagRelationモデルの登録機能' do
    ...
    context '不適切な内容があり登録できない' do
      ...
      it 'meal_idの重複があり登録できない' do
        ...
        another_meal_tag_relation = FactoryBot.build(:meal_tag_relation, meal_id: @meal_tag_relation.meal_id,
                                                                         tag: @meal_tag_relation.tag)
      ...
      it 'tag_idの重複があり登録できない' do
        @meal_tag_relation.save
        another_meal_tag_relation = FactoryBot.build(:meal_tag_relation, tag_id: @meal_tag_relation.tag_id,
                                                                         meal: @meal_tag_relation.meal)
        another_meal_tag_relation.valid?
